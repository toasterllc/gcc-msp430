...
#endif
#ifndef GENERATOR_FILE
  int x_VAR_msim_rom_model;
#define x_VAR_msim_rom_model do_not_use
#endif
#ifndef GENERATOR_FILE
...
#define MASK_USE_430X_FOR_MEM (1U << 5)
...
#define TARGET_USE_430X_FOR_MEM ((target_flags & MASK_USE_430X_FOR_MEM) != 0)
#define TARGET_USE_430X_FOR_MEM_P(target_flags) (((target_flags) & MASK_USE_430X_FOR_MEM) != 0)
...
enum opt_code
{
  ...
  OPT_msim = 1290,                           /* -msim */
  OPT_msim_rom_model = 1291,                 /* -msim-rom-model */
  OPT_msmall = 1292,                         /* -msmall */
  OPT_mtiny_printf = 1293,                   /* -mtiny-printf */
  OPT_muse_430x_for_mem = 1294,              /* -muse-430x-for-mem */
  OPT_muse_lower_region_prefix = 1295,       /* -muse-lower-region-prefix */
  OPT_mwarn_mcu = 1296,                      /* -mwarn-mcu */
  OPT_n = 1297,                              /* -n */
